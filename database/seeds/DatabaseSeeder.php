...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $permission = [
            ...
            [
                'name' => 'siteusers-add-delete',
                'display_name' => 'Add or delete site users',
                'description' => 'The User has access to add or delete site users'
            ],
            [
                'name' => 'siteusers-view',
                'display_name' => 'Viewing of site users',
                'description' => 'The user has access to view site users'
            ],
            [
                'name' => 'siteusers-edit',
                'display_name' => 'Editing of site users',
                'description' => 'The user has access to edit site users'
            ],
            ...
            [
                'name' => 'sliders-add-delete',
                'display_name' => 'Add or delete sliders items',
                'description' => 'The User has access to add or delete sliders items'
            ],
            [
                'name' => 'sliders-view',
                'display_name' => 'Viewing of sliders items',
                'description' => 'The user has access to view sliders items'
            ],
            [
                'name' => 'sliders-edit',
                'display_name' => 'Editing of sliders items',
                'description' => 'The user has access to edit sliders items'
            ],
