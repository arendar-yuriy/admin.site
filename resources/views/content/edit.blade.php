...
@section('central')
        ...
        <div class="tabbable nav-tabs-vertical nav-tabs-left">
            ...
            <div class="tab-content">
                <div class="tab-pane active has-padding" id="left-tab1">
                    <form class="form-horizontal" method="post" onsubmit="return Main.formSubmit(this);" action="{{ Route('update_content', ['id'=>$content->id]) }}">
    ...
    @else
        <form class="form-horizontal" >
            @include('content.view_'.$oStructure->controller)
        </form>
    @endif
