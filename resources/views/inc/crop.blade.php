          ...
          <span class="docs-tooltip" data-toggle="tooltip" title="cropper.setCropBoxData(data)">
            ...
            <span class="docs-tooltip" data-toggle="tooltip" title="View Mode 3">
              VM3
                ...
                <form action="{{ route($controller.'_crop',['id'=>$content->id]) }}" method="post" onsubmit="return Main.formSubmit(this);">
                    <input type="hidden" name="data_crop_info" id="imageInfo">
                    <input type="hidden" name="data_crop" id="putDataHidden">
                    <div class="text-right">
                        <a href="{{ route('edit_'.$controller,['id'=>Route::current()->parameter('id')]) }}" class="btn btn-primary"><i class="icon-arrow-left13 position-left"></i> {{ trans('app.back') }}</a>
